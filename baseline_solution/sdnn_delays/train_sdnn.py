...
if __name__ == '__main__':
    ...
    parser.add_argument('-lam', type=float, default=0.001, help='lagrangian factor')
    ...
    parser.add_argument('-scale_grad', type=float, default=0.8, help='surrogate gradient scale')
    parser.add_argument('-n_fft', type=int, default=512, help='number of FFT specturm, hop is n_fft // 4')
    parser.add_argument('-dmax', type=int, default=64,help='maximum axonal delay')
    parser.add_argument('-out_delay', type=int, default=0, help='prediction output delay (multiple of 128)')
    ...
    parser.add_argument('-path', type=str, default='../../test_datas/', help='dataset path')
    ...
    train_set = DNSAudio(root=args.path)
    validation_set = DNSAudio(root=args.path)
